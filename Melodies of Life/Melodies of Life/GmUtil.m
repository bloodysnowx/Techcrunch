...
static NSString * const API_KEY = @"607e1a3aef6daab6762fbf403";
static NSString * const SECRET_KEY = @"568b3426bd099b59";
...
- (NSDictionary*)invokeVehicleCommand:(NSString*)command {
    //NSString *urlStr = @"https://developer.gm.com/api/v1/account/vehicles/1GKUKEEF9AR000010/commands";
    NSString *urlStr = @"https://developer.gm.com/api/v1/account/vehicles/1GKUKEEF9AR000010/commands/alert";
    //NSString *urlStr = @"https://developer.gm.com/api/v1/account/vehicles/1GKUKEEF9AR000010/commands/lockDoor";
    //NSString *urlStr = @"https://developer.gm.com/api/v1/account/vehicles/1GKUKEEF9AR000010/commands/diagnostics";
